          ...
          <div> 
            ...
            <Carousel> 
                {this.state.images.map((image, pos) => {
                            return (
                              <Image src={`https://serverless-travel-images-bucket-regy-dev.s3.amazonaws.com/${image.travelId}%${image.imageId}`} wrapped  />
                            )
                        })
                }
            </Carousel>
          </div>
         : <h1>NO IMAGES UPLOADED FOR THAT TRAVEL YET :(</h1>}
